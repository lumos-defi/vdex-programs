...
mod test {
    ...
    fn test_add_and_remove_liquidity() {
        ...
        let (vlp_amount, fee) = dex
            .add_liquidity(3, sol(1000.), true, &oracles, &price_feed)
            .assert_unwrap();
        ...
        // Add 1 BTC
        let (vlp_amount, fee) = dex
            .add_liquidity(1, btc(1.), true, &oracles, &price_feed)
            .assert_unwrap();
        ...
        // Add 10000 usdc
        let (vlp_amount, fee) = dex
            .add_liquidity(2, usdc(10000.), true, &oracles, &price_feed)
            .assert_unwrap();
