...
use crate::utils::{
    ...
    constant::{
        TEST_BTC_ADD_LIQUIDITY_FEE_RATE, TEST_BTC_ASSET_INDEX, TEST_BTC_BORROW_FEE_RATE,
        TEST_BTC_CHARGE_BORROW_FEE_INTERVAL, TEST_BTC_CLOSE_FEE_RATE, TEST_BTC_DECIMALS,
        TEST_BTC_LIQUIDATE_FEE_RATE, TEST_BTC_MARKET_DECIMALS, TEST_BTC_MARKET_SYMBOL,
        TEST_BTC_MINIMUM_COLLATERAL, TEST_BTC_OPEN_FEE_RATE, TEST_BTC_ORACLE_EXPO,
        TEST_BTC_ORACLE_PRICE, TEST_BTC_ORACLE_SOURCE, TEST_BTC_REMOVE_LIQUIDITY_FEE_RATE,
        TEST_BTC_SIGNIFICANT_DECIMALS, TEST_BTC_SWAP_FEE_RATE, TEST_BTC_SYMBOL,
        ...
        TEST_ETH_DECIMALS, TEST_ETH_LIQUIDATE_FEE_RATE, TEST_ETH_MARKET_DECIMALS,
        TEST_ETH_MARKET_SYMBOL, TEST_ETH_MINIMUM_COLLATERAL, TEST_ETH_OPEN_FEE_RATE,
        TEST_ETH_ORACLE_EXPO, TEST_ETH_ORACLE_PRICE, TEST_ETH_ORACLE_SOURCE,
        TEST_ETH_REMOVE_LIQUIDITY_FEE_RATE, TEST_ETH_SIGNIFICANT_DECIMALS, TEST_ETH_SWAP_FEE_RATE,
        TEST_ETH_SYMBOL, TEST_ETH_TARGET_WEIGHT, TEST_SOL_ADD_LIQUIDITY_FEE_RATE,
        TEST_SOL_ASSET_INDEX, TEST_SOL_BORROW_FEE_RATE, TEST_SOL_CHARGE_BORROW_FEE_INTERVAL,
        TEST_SOL_CLOSE_FEE_RATE, TEST_SOL_DECIMALS, TEST_SOL_LIQUIDATE_FEE_RATE,
        TEST_SOL_MARKET_DECIMALS, TEST_SOL_MARKET_SYMBOL, TEST_SOL_MINIMUM_COLLATERAL,
        ...
        TEST_SOL_SWAP_FEE_RATE, TEST_SOL_SYMBOL, TEST_SOL_TARGET_WEIGHT,
        TEST_USDC_ADD_LIQUIDITY_FEE_RATE, TEST_USDC_BORROW_FEE_RATE, TEST_USDC_DECIMALS,
        TEST_USDC_ORACLE_EXPO, TEST_USDC_ORACLE_PRICE, TEST_USDC_REMOVE_LIQUIDITY_FEE_RATE,
        TEST_USDC_SWAP_FEE_RATE, TEST_USDC_SYMBOL, TEST_USDC_TARGET_WEIGHT,
    },
...
use crate::utils::{TestResult, INIT_ADD_SOL_AMOUNT};
use anchor_client::{
    solana_sdk::{
...
impl DexTestContext {
    ...
    pub async fn new() -> DexTestContext {
        DexTestContext::new_raw(false).await
    }
